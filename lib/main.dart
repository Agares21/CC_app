...
class _CloudApiCCAppState extends State<CloudApiCCApp> {
  ...
  void initState() {
    ...
    _suscripciones.addAll([
      ...
      // Con la app en primer plano Android no muestra nada, así que el aviso se
      // aprovecha para refrescar en el acto en vez de esperar al polleo.
      widget.pushService.onForegroundMessage.listen((_) => _chatsBloc.add(ChatsRefreshSilent())),
    ]);
  }
