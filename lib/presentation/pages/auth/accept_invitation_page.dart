...
/// Página para aceptar invitación y crear contraseña.
class AcceptInvitationPage extends StatelessWidget {
  final String token;
  final String email;
  const AcceptInvitationPage({super.key, required this.token, required this.email});
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('Crear contrase\u00f1a', style: AppTextStyles.headingLg.copyWith(color: Colors.white)),
                          const SizedBox(height: 4),
                          Text('Activa tu acceso a Cloud API CC', style: AppTextStyles.caption.copyWith(color: Colors.white70)),
                        ],
                      ),
                    ),
                    Padding(
